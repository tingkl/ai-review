...
DEFAULT_SYSTEM_MESSAGE = (
    ...
    + _REVIEW_DATA_STRUCTURE +
    "\n"
    "📌 注释是代码意图的重要说明（优先级高于案例）：\n"
    "  - 代码中的注释是开发者写的意图说明，比代码本身更直接\n"
    "  - 判断代码是否正确时，要参考注释的说明\n"
    "  - 如果注释明确解释了某个做法的原因，要尊重注释的判断\n"
    "  - 不要无视注释，仅凭代码表面就下结论\n"
    "  - 📌 以下情况不要报 issue（注释已提供合理说明）：\n"
    "      • 注释说明是'测试用途'/'临时方案'/'已知问题'\n"
    "      • 注释明确解释了为什么使用当前做法（如为什么用 console.log）\n"
    "      • 注释标了 TODO/FIXME 且说明了原因\n"
