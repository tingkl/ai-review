...
DEFAULT_JSON_FIX_SYSTEM_MESSAGE = (
    ...
    "      • category 必须是以下之一：bug, security, style, performance, best-practice, documentation\n"
    "        原值是中文时映射：代码风格→style, Bug检测→bug, 最佳实践→best-practice, 性能→performance, 安全→security, 文档→documentation\n"
    "      • severity 必须是：critical, error, warning, info\n"
